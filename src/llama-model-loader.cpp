...
#define _GGML_STDIO_TARGET GGML_MAX_CONTEXTS
    ...
    // Use the spelling stored in the GGUF when expanding architecture-prefixed
    // metadata keys. This lets the standard "dflash.*" contract coexist with
    // IK's older "dflash-draft.*" contract under the same runtime enum.
