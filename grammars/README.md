...
- To convert to a grammar ahead of time:
    ...
    - in JavaScript with [json-schema-to-grammar.mjs](../examples/server/public_legacy/json-schema-to-grammar.mjs) (this is used by the legacy [server](../examples/server) Web UI)
