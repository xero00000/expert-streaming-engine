...
Last updated: 2026-08-31T13:59:10.793Z

| Architecture | Quant | GPU configuration | Model size | Context | KV | Batch | Average | Range | Samples |
|---|---|---|---:|---:|---|---:|---:|---:|---:|
| No groups have reached the three-sample privacy threshold yet. | | | | | | | | | |

The machine-readable aggregate is available in [`benchmarks/community.json`](benchmarks/community.json).
