...
struct gpt_params {
    ...
    int64_t expert_ram_cache_mib = 0; // explicit bounded native expert RAM tier; 0 disables
    int64_t expert_ram_staging_mib = 0; // 0 = max(largest component, min(cache, 64 MiB))
    std::string expert_storage_backend = "pread";
